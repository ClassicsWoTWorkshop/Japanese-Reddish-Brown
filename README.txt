...
Included are skins for all the HD Japanese tanks, matching icons for the garage and tech tree, and an optional flag change mod.
...
Optional:
- If you want to also change the default Japanese flag (edit: might not be completely historical, but I still like it), drag the "res_mods" folder from inside the ADDON - FLAG CHANGE folder to your World of Tanks install directory as well.
